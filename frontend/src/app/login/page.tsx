    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl">
          <h1 className="text-3xl font-bold text-center mb-8 glow-text-lavender">Login</h1>
          ...
          <p className="mt-8 text-center text-sm text-grey-blue">
            ...
            <Link className="text-muted-lavender hover:text-white transition-colors font-medium" href="/register">
              Create one
            </Link>
          </p>
        </div>
